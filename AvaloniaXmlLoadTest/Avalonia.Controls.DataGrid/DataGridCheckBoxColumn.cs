...
namespace Avalonia.Controls
{
    ...
    public class DataGridCheckBoxColumn : DataGridBoundColumn
    {
        ...
        protected override IControl GenerateElement(DataGridCell cell, object dataItem)
        {
            ...
            if (EnsureOwningGrid() && cell.RowIndex != -1 &&
                cell.ColumnIndex != -1 && cell.OwningRow != null &&
        ...
        private void OwningGrid_CurrentCellChanged(object sender, EventArgs e)
        {
            ...
            if (OwningGrid != null && OwningGrid.CurrentColumn == this &&
                ...
                OwningGrid.DisplayData.GetDisplayedElement(OwningGrid.CurrentSlot) is DataGridRow row)
            {
        ...
        {
            if (OwningGrid != null && GetCellContent(e.Row) is CheckBox checkBox)
            {
