...
namespace Avalonia.Controls
{
    public abstract class DataGridColumn : AvaloniaObject
    {
        ...
        private Classes _cellStyleClasses = new Classes();
        ...
        public bool IsVisible
        {
            ...
            set
            {
                if (value != IsVisible)
                {
                    ...
                    // Сбрасываем сортировку, если  колнка не видна.
                    if (!_isVisible)
                    {
                        DataGridSortDescription sort = GetSortDescription();
                        if (sort != null)
                        {
        ...
        public int DisplayIndex
        {
            get
            {
                ...
                {
                    return DisplayIndexWithFiller - 1;
                }
                else
                {
                    return DisplayIndexWithFiller;
                }
            }
            set
            {
                ...
                if (OwningGrid != null)
                {
                    ...
                    if (DisplayIndexWithFiller != value)
                    {
        ...
        internal void ComputeLayoutRoundedWidth(double leftEdge)
        {
            ...
            {
				double roundedLeftEdge = Math.Floor(leftEdge);
				double roundedRightEdge = Math.Floor(leftEdge + ActualWidth);
        ...
        internal string GetSortPropertyName()
        {
            ...
            if (string.IsNullOrEmpty(result) &&
                this is DataGridBoundColumn boundColumn &&
