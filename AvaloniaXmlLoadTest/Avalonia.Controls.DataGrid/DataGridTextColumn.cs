...
namespace Avalonia.Controls
{
    ...
    public class DataGridTextColumn : DataGridBoundColumn
    {
        ...
        /// <summary>
        /// Задает, когда поддерживает несколько строчек.
        /// </summary>
        public static readonly StyledProperty<bool> IsMultilineProperty =
            AvaloniaProperty.Register<DataGridTextColumn, bool>(nameof(IsMultiline));
        ...
        {
            get { return GetValue(IsMultilineProperty); }
        ...
        protected override IControl GenerateEditingElementDirect(DataGridCell cell, object dataItem)
        {
            ...
            if (IsSet(IsMultilineProperty)&&IsMultiline)
            {
